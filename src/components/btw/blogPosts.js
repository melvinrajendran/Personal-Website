const blogPosts = [
  {
    ...
    date: "JULY 04, 2021",
    body: [
      <span>After years of putting it off, I finally got around to buying my first vinyl record and starting a collection.</span>,
      <span>
        ...
        <a href="https://open.spotify.com/album/42fyKPanos0Q3woi848ktg?si=l70SrdDYTV-7hOoYjQkn4Q&dl_branch=1" class="link-dark">
          <em>Imperial</em>
        </a>{" "}
        by Denzel Curry. Spoiler alert: I bought it.
      </span>,
      <span>Now, as I format the &lt;p&gt; tags for what I hope will be a long-term blog, this album is playing in the background. While I’m still in search of the perfect turntable and speakers to hear the “crisp, warm” audio that audiophiles preach comes with vinyl, Spotify will cut it for now.</span>,
      <span>
        ...
        <a href="https://blog.codinghorror.com/the-one-thing-programmers-and-musicians-have-in-common/" class="link-dark">
          blog
        </a>
        :
      </span>,
      <ul class="article-body fw-bold h6 pb-2">
        <li>
      ...
      <span>Interestingly enough, music production and software engineering demand the same attention to detail, abstract thinking, and ability to zoom out, seeing how small changes impact a big project.</span>
    ]
  }
];
