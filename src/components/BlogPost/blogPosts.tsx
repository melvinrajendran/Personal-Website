...
const blogPosts = [
    ...
    },
    {
      ...
      body: [
        ...
        <p>
          Now, as I format the &lt;p&gt; tags for what I hope will be a long-term blog, this album
          is playing in the background. While I’m still in search of the perfect turntable and
          speakers to hear the “crisp, warm” audio that audiophiles preach comes with vinyl, Spotify
          will cut it for now.
        </p>,
        <p>
          In more ways than one, I’ve seen parallels between music and programming. In every CS
          class that I’ve taken in high school, songs ranging from pop hits to punk rock have served
          as the backdrop to the meticulous keyboard taps and mouse clicks. Some of the most avid
          music listeners I know are programmers. But it’s so much more than that. Here’s some
          insights from Jeff Atwood’s{' '}
          <a
        ...
        <p>
          Interestingly enough, music production and software engineering demand the same attention
          to detail, abstract thinking, and ability to zoom out, seeing how small changes impact a
          big project.
        </p>,
      ],
    },
  ],
  activeMonths: Array<CalendarMonth> = [];
